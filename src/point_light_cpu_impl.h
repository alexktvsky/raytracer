...
#error "point_light_cpu_impl.h contains implementation and must not be used directly."
#endif


Color PointLight::calculateColor(const Intersect &intersect) const
{
    float diffuse_light_intensity = 0.f;
    glm::vec3 l = m_pos - intersect.getPoint();
